...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <span className="hidden sm:block absolute right-16 bg-gray-900 text-white text-xs font-medium px-3 py-1.5 rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
        Chat on WhatsApp
      </span>
    </a>
  );
